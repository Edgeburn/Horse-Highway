...
public class SpeedConversionUtil {
    ...
    public static double calculateGenericMovementSpeedFromMetresPerSecond(double speedInMetresPerSecond) {
    ...
    public static double calculateKphFromGenericMovementSpeed(double speedInGenericMovementSpeed) {
        return round(calculateKphFromMetresPerSecond(speedInGenericMovementSpeed * GENERIC_MOVEMENT_SPEED_MAGIC_NUMBER), 1);
    ...
    public static double round(double value, int places) {
        ...
        * Original version should work fine here since we're only returning 1 or decimal places in all places it's used
        * If in the future the safer version is required, can easily be swapped in place
        */
