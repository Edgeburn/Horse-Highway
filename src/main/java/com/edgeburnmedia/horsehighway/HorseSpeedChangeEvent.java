...
public class HorseSpeedChangeEvent extends Event implements Cancellable {
    ...
    public HorseSpeedChangeEvent(HorseManager horseManager, Material material, double previousSpeed) {
    ...
    public double getNewSpeed() {
        ...
        if (speed != null) {
            ...
            return SpeedConversionUtil.calculateKphFromGenericMovementSpeed(horseManager.getDefaultSpeed());
        }
    }
